            ...
            setTimeout(
                function waaaait() {
                    $('#contactUsContainer').css('margin-top','1.4em')
                        $('#contactUsText').replaceWith('<div id="contactUsText"><p><c2>' + lang.contacts + ':</c2></p><p><c2>' + lang.phone + ': </c2>' + superAntiBotMeasure(code.phone) + '</p><p><c2>Email: </c2>' + superAntiBotMeasure(code.mail) + '</p><p><c2>Facebook:</c2><a target="_blank" href="https://www.facebook.com/nandor.biro.7">Facebook.com</p><p><c2>'+ lang.address +' :</c2><a target="_blank" href="' + superAntiBotMeasure(code.address) + '">Google ' + lang.map + '</p></div></div>');
                        $('#contactUsFooter').replaceWith('<div class="footerContainer" id="contactUsFooter"><p><f1>' + lang.contacts + ':</f1></p><p>' + lang.phone + ': ' + superAntiBotMeasure(code.phone) + '</p><p>Email: ' + superAntiBotMeasure(code.mail) + '</p><p><a target="_blank" href="https://www.facebook.com/nandor.biro.7">Facebook.com</a></p><p><a target="_blank" href=" ' + superAntiBotMeasure(code.address) + '">Google ' + lang.map + '</a></p></div>');
                }, 250);
        }
    });
